import type { Connection, ConnectionLike, Element, Shape } from 'diagram-js/lib/model/Types';
import { append as svgAppend, classes as svgClasses, type KeyValue } from 'tiny-svg';
...
export default abstract class CacaoBaseConnection {
	 ...
	 * @returns
	 */
	protected drawLineConnection(parentGfx: SVGElement, element: Connection, attrs: KeyValue) {
		let line: SVGElement;
	...
	protected drawEmbeddedLabel(
		...
		CacaoConnectionLabelUtil.defineLabelPosition(label, element, preferredPosition);
	}
}
