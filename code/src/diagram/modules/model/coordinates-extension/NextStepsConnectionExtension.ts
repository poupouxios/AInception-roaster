...
export interface NextStepsConnectionExtensionProps extends ConnectionExtensionProps {
	next_step: Identifier;
}

export interface NextStepsConnectionExtension extends NextStepsConnectionExtensionProps {}
